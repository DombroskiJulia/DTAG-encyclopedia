...
%     mj changed fint1 to 16000 to enable use with all dtag sampling rates
%     19 july 2015
...
fint1 = 16000 ;            % 1st intermediate sampling rate for audio, Hz
...
%  3. decimate to a sampling-rate of 16kHz
...
while cue<endcue,
   ...
   [y,Z1] = decz(x,Z1) ;        % 1. y is at fint1 (8kHz BW)
