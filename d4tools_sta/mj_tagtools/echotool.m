function    [DD,W] = echotool(tag,cue,CL,intervl,DD,DMON)
%
%     DD=echotool(tag,cue,CL,[intervl,DD,DMON])
...
figs = [1 2 3 4] ;         % which figure windows to use
...
while next<2,
  ...
  % x = x(:,2); %!!!
      ...
      if size(x,2)==1 & nargin>5 & ~isempty(DMON),
