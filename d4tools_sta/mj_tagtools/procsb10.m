function    [T,DTAB] = procsb10(stag,pr,SStab,CL,Dd,Ds)
%
%    [T,DTAB] = procsb10(stag,pr,SStab,CL,Dd,Ds)
%
% example:
...
% T=procsb10('md10_163a',200,SStab,CL,Da,Dsa);
%
% pr is the depth of the receiver
...
cd = pathintspeed(SStab,ps,pr*ones(length(ps),1)) ;
cs = pathintspeed(SStab,ps,-pr*ones(length(ps),1)) ;
